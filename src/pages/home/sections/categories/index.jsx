...
export default function Categories() {
  ...
  return (
    <Section
      ...
      description="İyi bir kariyer için, doğru bir başlangıç gerekir. Prototürkmen'de bir çok dil ve teknolojiye ait derslerle doğru bir başlangıç yapmaya hazırsın!"
    >
      {isLoading && '.....'}
      {isError && (
